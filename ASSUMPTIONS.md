...
* **Defensive Error Handling:** The service checks against known valid country code models and returns appropriate HTTP status codes (e.g., `400 Bad Request`) for invalid, non-existent, or unsupported codes.
